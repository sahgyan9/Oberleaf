...
| **Document Outline & Section Drag-and-Drop** (Hierarchical section tree, click-to-jump, atomic Monaco buffer reordering, undo safety) | [`src/utils/latexOutline.ts`](file:///c:/Users/sahgy/Downloads/overleaf-copy/src/utils/latexOutline.ts)<br>[`src/components/Outline/OutlinePanel.tsx`](file:///c:/Users/sahgy/Downloads/overleaf-copy/src/components/Outline/OutlinePanel.tsx)<br>[`src/App.tsx`](file:///c:/Users/sahgy/Downloads/overleaf-copy/src/App.tsx) | `parseLatexOutline()`, `computeSectionMove()`, `handleJumpToSectionLine()`, `handleReorderSection()`, `[Files \| Outline]` sidebar tabs |
